...
const FilePreviewModal = ({ file, onClose }) => {
    ...
    const allFiles = useMemo(() => {
        ...
        return file.docName.split(",").map((f) => f.trim()).filter(Boolean);
    }, [file?.docName]);
                            ...
                            >
                                <Button
                                    ...
                                    sx={{
                                        ...
                                        borderColor: 'blue',
                                        "&.Mui-disabled": {
                                            color: "blue",        // keep blue even when disabled
                                            borderColor: "#90caf9",
                                            opacity: 0.5,         // just fade it slightly instead
                                        },
                                    }}
                                    disabled={imgIndex === 0}
                                ...
                                <Button
                                    ...
                                    variant="outlined"
                                    sx={{
                                        minWidth: 32, px: 1, fontSize: 13, color: 'blue', "&.Mui-disabled": {
                                            color: "blue",
                                            borderColor: "#90caf9",
                                            opacity: 0.5,
                                        },
                                    }}
                                    disabled={imgIndex === allFiles.length - 1}
                                    onClick={() => setImgIndex((p) => p + 1)}
