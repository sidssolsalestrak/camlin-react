...
function KPIReport() {
    ...
    const STATIC_COLUMNS = [
        ...
        { field: "num_dist_per",width:30, headerName: "Numeric Distribution %", renderCell: ({ value }) => <Box sx={{textAlign:'center'}} >{fmtF(value)}</Box> },
        ...
        { field: "coverage_per", headerName: "Coverage %", renderCell: ({ value }) => <Box sx={{textAlign:'center'}}>{fmtF(value)}</Box> },
        ...
        { field: "prod_per", headerName: "Productivity %", renderCell: ({ value }) => <Box sx={{textAlign:'center'}}>{fmtF(value)}</Box> },
        { field: "unq_mtd_pc_call", headerName: "Unique Productive Calls", renderCell: ({ value }) => <Box>{zeroToNullRound(value)}</Box> },
        { field: "unq_prod_per", headerName: "Unique Productivity %", renderCell: ({ value }) => <Box sx={{textAlign:'center'}}>{fmtF(value)}</Box> },
        ...
        { field: "lpc_per", headerName: "Avg. LPC", renderCell: ({ value }) => <Box sx={{textAlign:'center'}}>{fmtF(value)}</Box> },
        ...
        { field: "visible_per", headerName: "Visibility %", renderCell: ({ value }) => <Box sx={{textAlign:'center'}}>{fmtF(value)}</Box> },
