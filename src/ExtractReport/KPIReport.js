...
function KPIReport() {
    ...
    const STATIC_COLUMNS = [
        ...
        { field: "sale_tgt", headerName: `${dayjs(reportMonth).format('MMM YYYY')}-Tgt`, type: "alignright", renderCell: ({ value }) => <Typography>{fmt(value)}</Typography> },
        { field: "tot_cus", headerName: "Total Outlets", type: "alignright", renderCell: ({ value }) => <Typography>{fmt(value)}</Typography> },
        { field: "tot_call", headerName: "Total Calls", type: "alignright", renderCell: ({ value }) => <Typography>{fmt(value)}</Typography> },
        { field: "eco_no", headerName: "Total Outlets Visited", type: "alignright", renderCell: ({ value }) => <Typography>{fmt(value)}</Typography> },
        { field: "repeated", headerName: "Total Outlets Repeated", type: "alignright", renderCell: ({ value }) => <Typography>{fmt(value)}</Typography> },
        { field: "num_dist_per", width: 30, headerName: "Numeric Distribution %", type: "alignright", renderCell: ({ value }) => <Box sx={{ fontWeight: 600 }}>{fmtF(value)}</Box> },
        { field: "tot_field_day", headerName: "Field Days", type: "alignright", renderCell: ({ value }) => <Typography>{fmt(value)}</Typography> },
        { field: "call_dy_tgt", headerName: "Calls/Day Target", type: "alignright", renderCell: ({ value }) => <Typography>{fmt(value)}</Typography> },
        { field: "mtd_tot_call", headerName: "Actual", type: "alignright", renderCell: ({ value }) => <Typography>{fmtF(value)}</Typography> },
        { field: "coverage_per", headerName: "Coverage %", type: "alignright", renderCell: ({ value }) => <Box sx={{ fontWeight: 600 }}>{fmtF(value)}</Box> },
        { field: "prod_dy_tgt", headerName: "Productivity Tgt", type: "alignright", renderCell: ({ value }) => <Typography>{fmtF(value)}</Typography> },
        { field: "mtd_tot_pc", headerName: "Actual", type: "alignright", renderCell: ({ value }) => <Typography>{fmtF(value)}</Typography> },
        { field: "prod_per", headerName: "Productivity %", type: "alignright", renderCell: ({ value }) => <Box sx={{ fontWeight: 600 }}>{fmtF(value)}</Box> },
        { field: "unq_mtd_pc_call", headerName: "Unique Productive Calls", renderCell: ({ value }) => <Box>{zeroToNullRound(value)}</Box> },
        { field: "unq_prod_per", headerName: "Unique Productivity %", type: "alignright", renderCell: ({ value }) => <Box sx={{ fontWeight: 600 }}>{fmtF(value)}</Box> },
        ...
        { field: "lpc_per", headerName: "Avg. LPC", type: "alignright", renderCell: ({ value }) => <Box sx={{ fontWeight: 600 }}>{fmtF(value)}</Box> },
        { field: "visible_dy_tgt", headerName: "Visibility Tgt", type: "alignright", renderCell: ({ value }) => <Typography>{fmtF(value)}</Typography> },
        { field: "mtd_visible_cnt", headerName: "Actual", type: "alignright", renderCell: ({ value }) => <Typography>{fmtF(value)}</Typography> },
        { field: "visible_per", headerName: "Visibility %", type: "alignright", renderCell: ({ value }) => <Box sx={{ fontWeight: 600 }}>{fmtF(value)}</Box> },
        { field: "train_stat", headerName: "Training Done (Y/N)", renderCell: ({ value }) => value || "-" },
        { field: "cap_index", headerName: "Capability Index %", type: "alignright", renderCell: ({ value }) => <Typography>{fmtF(value)}</Typography> },
        { field: "exe_tier", headerName: "Execution Tier", renderCell: ({ value }) => <Box sx={tierStyle(value)}>{value || "-"}</Box> },
        { field: "p_mult", headerName: "Potential Multiplier", type: "alignright", renderCell: ({ value }) => <Typography>{value ? `${Number(value).toFixed(2)}%` : "-"}</Typography> },
        { field: "exp_sec_val", headerName: "Expected Secondary", type: "alignright", renderCell: ({ value }) => <Typography>{fmt(value)}</Typography> },
        { field: "exp_pri_val", headerName: "Expected Primary", type: "alignright", renderCell: ({ value }) => <Typography>{fmt(value)}</Typography> },
        { field: "sec_val", headerName: "Actual Secondary", type: "alignright", renderCell: ({ value }) => <Typography>{fmt(value)}</Typography> },
        { field: "pri_val", headerName: "Actual Primary", type: "alignright", renderCell: ({ value }) => <Typography>{fmt(value)}</Typography> },
        { field: "sec_diff", headerName: "Secondary Difference", type: "alignright", renderCell: ({ value }) => <Typography>{fmt(value)}</Typography> },
        { field: "pri_diff", headerName: "Primary Difference", type: "alignright", renderCell: ({ value }) => <Typography>{fmt(value)}</Typography> },
    ];
