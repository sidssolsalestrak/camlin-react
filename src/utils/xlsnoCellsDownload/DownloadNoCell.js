...
export const DownloadNoCell = async (
  data,
  columns,
  filename,
  setProgress,
  ...
  const worker = new Worker(new URL("./ExcelWorkerSheet", import.meta.url));
  worker.postMessage({ data, columns: safeColumns, filename, moduleType, additionalData, grandTotal, });
