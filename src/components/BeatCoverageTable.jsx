...
import { buildMonthNames, groupBeatCoverageRows, buildDisplayRows } from '../utils/beatCoverageHelpers';
                ...
                <Table size="small" stickyHeader>
                    <TableHead>
                        <TableRow>
                            <TableCell
                                rowSpan={2}
                                sx={{ ...headerCellBase, position: 'sticky', top: 0, zIndex: 5, borderRight: BORDER }}
                            >
                                SI
                            </TableCell>
                            <TableCell
                                rowSpan={2}
                                sx={{ ...headerCellBase, position: 'sticky', top: 0, zIndex: 5, width: '18%' }}
                            >
                                Sales Person
                            </TableCell>
                            <TableCell
                    ...
                    <TableBody>
                        {displayRows.length === 0 ? (
                            <TableRow>
                                <TableCell colSpan={16} align="center" sx={{ py: 4, border: 'none' }}>
                                        ...
                                        <TableCell sx={cellBase}>
                                            {row.si != null && (
                                                <Box>
                                                    ...
                                                    <Typography
                                                        sx={{ fontSize: '11px', fontStyle: 'italic', color: '#9ca3af' }}
                                                        title={row.hq_name}
                                                    >
                                                        HQ:{row.hq_name}
                                                    </Typography>
